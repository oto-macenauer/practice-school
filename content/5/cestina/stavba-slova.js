  ...
  sections: [
    {
      ...
      items: [
        ...
        { prompt: "Které písmeno není samohláska?", options: ["ř", "ě", "ů", "í"], answer: "ř", explanation: "Samohlásky jsou a, e, i, o, u, y (krátké i dlouhé) a dvojhlásky ou, au, eu. Ř je souhláska." },
    ...
    },
    {
      ...
      items: [
        ...
        { prompt: "Jaký je kořen slova UČITELKA?", options: ["uč", "učit", "tel", "ka"], answer: "uč", explanation: "UČ-itel-ka. Příbuzná: učit, učitel, učebnice, naučit." },
        ...
        { prompt: "Jaký je kořen slova ZAHRÁDKÁŘ?", options: ["hrad", "hrád", "zahrád", "ář"], answer: "hrád", explanation: "ZA-hrád-KÁŘ. Kořen souvisí se slovem zahrada (za-hrad-a), tady s dlouhým á." },
    ...
    },
    {
      ...
      items: [
        ...
        { prompt: "Jaká předpona je ve slově BEZDOMOVEC?", options: ["bez-", "be-", "dom-", "-ec"], answer: "bez-", explanation: "BEZ-dom-ovec. Předpona bez- znamená „nemá“." },
    ...
    },
    {
      ...
      items: [
        ...
        { prompt: "Jaká přípona tvoří slovo DOMEČEK?", options: ["-eček", "dom-", "-ček", "-ek"], answer: "-eček", explanation: "DOM-eček. Dvojitá zdrobnělina: dům → domek → domeček." },
        ...
        { prompt: "Které slovo má příponu -OST?", options: ["radost", "rost", "most", "kost"], answer: "radost", explanation: "RAD-ost (od radovat se). MOST a KOST jsou celé kořeny." },
        { prompt: "Jaká přípona vytvoří z ČESKO přídavné jméno?", options: ["-ý", "-ník", "-ost", "-ák"], answer: "-ý", explanation: "česk-ý. Přídavná jména končí koncovkami -ý, -í, -á, -é." },
    ...
    },
    {
      ...
      items: [
        ...
        { prompt: "Napiš zdrobnělinu slova STŮL.", answer: "stoleček", accept: ["stolek"], explanation: "stůl → stolek → stoleček. Ve zdrobnělině se ů mění na o." },
        { prompt: "Napiš, jak se jmenuje člověk, který peče pečivo.", answer: "pekař", explanation: "kořen pek- + přípona -ař = pekař." },
        { prompt: "Napiš sloveso se stejným kořenem jako slovo SVĚTLO (co dělá lampa).", answer: "svítit", accept: ["svítí"], explanation: "Kořeny svět-/svít- jsou příbuzné: světlo, svítit, osvětlení." },
        { prompt: "Napiš, jak se jmenuje místo, kde se peče chleba.", answer: "pekárna", explanation: "pek- + -árna = pekárna (přípona -árna označuje místo)." },
        { prompt: "Přidej ke slovu LÉT(AT) předponu PŘI- a napiš tvar PŘI___ (minulý čas: letadlo už ___).", answer: "přiletělo", accept: ["přiletěl"], explanation: "při- + letělo = přiletělo." }
      ]
    }
  ]
});
