  ...
  sections: [
    {
      ...
      items: [
        ...
        { prompt: "Co má hmyz místo vnitřní kostry?", options: ["pevnou vnější kostru", "jen kůži", "chrupavku", "páteř z chitinu"], answer: "pevnou vnější kostru", explanation: "Vnější kostru z chitinu. Při růstu ji hmyz svléká." },
        ...
        { prompt: "Který živočich je měkkýš?", options: ["hlemýžď", "mravenec", "rak", "ropucha"], answer: "hlemýžď", explanation: "Měkkýši mají měkké tělo, často se schránkou: hlemýžď, slimák, škeble." },
        ...
        { prompt: "Který z těchto živočichů je obratlovec?", options: ["netopýr", "moucha", "pavouk", "hlemýžď"], answer: "netopýr", explanation: "Netopýr je savec – má páteř a kojí mláďata mlékem." }
      ]
    },
    {
      id: "tridy-obratlovcu",
      ...
      items: [
        ...
        { prompt: "Co mají všichni savci?", options: ["mléčné žlázy", "šupiny a žábry", "peří a zobák", "vnější kostru"], answer: "mléčné žlázy", explanation: "Samice kojí mláďata mlékem. Srst má většina savců, ale třeba delfín skoro žádnou." },
        ...
        { prompt: "Který z těchto živočichů klade vejce na souši?", options: ["želva", "skokan", "netopýr", "ježek"], answer: "želva", explanation: "Plazi kladou vejce s pevnou nebo kožovitou schránkou na suchu." },
    ...
    },
    {
      ...
      items: [
        ...
        { prompt: "Čím začíná potravní řetězec?", options: ["rostlinou", "masožravcem", "býložravcem", "houbou"], answer: "rostlinou", explanation: "Rostlina si dokáže vytvořit potravu z vody a oxidu uhličitého pomocí světla – je producent." },
        ...
        { prompt: "Jak se říká organismům, které rozkládají odumřelé zbytky?", options: ["rozkladači", "producenti", "predátoři", "opylovači"], answer: "rozkladači", explanation: "Žížaly, bakterie a houby vracejí živiny do půdy." },
    ...
    },
    {
      ...
      items: [
        ...
        { prompt: "srna", answer: "savec", explanation: "Srst a mláďata kojená mlékem." },
        ...
        { prompt: "ještěrka obecná", answer: "plaz", explanation: "Když ji někdo chytí za ocas, odhodí ho a naroste jí nový." },
