  ...
  sections: [
    {
      ...
      items: [
        ...
        { prompt: "K čemu slouží květ?", options: ["k rozmnožování", "k dýchání", "k nasávání vody", "k ukotvení rostliny"], answer: "k rozmnožování", explanation: "V květu je tyčinka (pyl) a pestík (semeník) – po opylení vznikne plod se semeny." },
        { prompt: "Co vzniká z oplodněného pestíku?", options: ["plod se semeny", "nový list", "další květ", "kořen"], answer: "plod se semeny", explanation: "Plod chrání semena a pomáhá jejich rozšíření." },
        ...
        { prompt: "Jak se jmenuje zelené barvivo v listech?", options: ["chlorofyl", "kolagen", "pigment", "chlorid"], answer: "chlorofyl", explanation: "Chlorofyl zachycuje energii ze slunce." },
    ...
    },
    {
      ...
      pick: "auto",
      items: [
        { prompt: "Který rostlinný typ má dřevnatý kmen a korunu?", options: ["strom", "bylina", "keř", "mech"], answer: "strom", explanation: "Strom má jeden kmen, keř se větví hned u země, bylina je nedřevnatá." },
        { prompt: "Čím se keř liší od stromu?", options: ["Větví se hned u země, nemá kmen", "Je vždy vyšší", "Nemá listy", "Nekvete"], answer: "Větví se hned u země, nemá kmen", explanation: "Například šípek, rybíz nebo bezinka." },
        ...
        { prompt: "Co je to okopanina?", options: ["Rostlina pěstovaná pro podzemní části, třeba brambor", "Rostlina, která roste v okopu", "Keř s bobulemi", "Rostlina bez listů"], answer: "Rostlina pěstovaná pro podzemní části, třeba brambor", explanation: "Okopaniny: brambory, řepa, mrkev – kolem se okopává půda." }
      ]
    },
    {
      id: "houby",
      ...
      pick: "auto",
      items: [
        { prompt: "Proč houby nejsou rostliny?", options: ["Nemají chlorofyl a neumí fotosyntézu", "Nemají žádné buňky", "Rostou jen v zimě", "Nemají semena"], answer: "Nemají chlorofyl a neumí fotosyntézu", explanation: "Houby si nevyrábějí cukry samy – živiny berou z odumřelých zbytků nebo od jiných organismů." },
        ...
        { prompt: "Která houba je parazit stromů?", options: ["choroš", "bedla", "liška", "žampion"], answer: "choroš", explanation: "Choroše rostou na kmenech a rozkládají dřevo." },
    ...
    },
    {
      ...
      items: [
        ...
        { prompt: "Část rostliny, která nasává vodu z půdy, je ___.", answer: "kořen", explanation: "Kořen rostlinu také ukotví." },
        { prompt: "Houby se rozmnožují ___ (co se tvoří pod kloboukem).", answer: "výtrusy", explanation: "Výtrusy roznáší vítr." },
        { prompt: "Rostlina s nedřevnatým stonkem se nazývá ___.", answer: "bylina", explanation: "Byliny × keře × stromy." }
      ]
    }
  ]
});
