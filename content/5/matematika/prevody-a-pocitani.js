// Matematika 5. třída – převody jednotek (délka, hmotnost, objem, čas),
  ...
  sections: [
    {
      ...
      items: [
        ...
        { prompt: "Kolik milimetrů je 7 cm?", options: ["70 mm", "7 mm", "700 mm", "17 mm"], answer: "70 mm", explanation: "1 cm = 10 mm, tedy 7 × 10 = 70 mm." },
        ...
        { prompt: "Co platí o délkách 900 cm a 9 m?", options: ["jsou stejně dlouhé", "900 cm", "9 m", "nelze porovnat"], answer: "jsou stejně dlouhé", explanation: "9 m = 900 cm." },
        { prompt: "Kolik dm je 4 m?", options: ["40 dm", "4 dm", "400 dm", "14 dm"], answer: "40 dm", explanation: "1 m = 10 dm." },
        ...
        { prompt: "Kolik metrů je 25 000 cm?", options: ["250 m", "25 m", "2500 m", "205 m"], answer: "250 m", explanation: "Dělíme 100: 25 000 : 100 = 250 m." },
        { prompt: "Sečti 3 m 40 cm + 1 m 80 cm.", options: ["5 m 20 cm", "4 m 20 cm", "5 m 120 cm", "4 m 80 cm"], answer: "5 m 20 cm", explanation: "40 + 80 = 120 cm = 1 m 20 cm, tedy 3 + 1 + 1 = 5 m a 20 cm." },
    ...
    },
    {
      ...
      items: [
        ...
        { prompt: "Kolik je 1250 g v kilogramech a gramech?", options: ["1 kg 250 g", "12 kg 50 g", "125 kg", "1 kg 25 g"], answer: "1 kg 250 g", explanation: "1250 g = 1000 g + 250 g." },
        ...
        { prompt: "Kolik dag je 500 g?", options: ["50 dag", "5 dag", "500 dag", "5000 dag"], answer: "50 dag", explanation: "1 dag (dekagram) = 10 g, takže 500 : 10 = 50 dag." },
    ...
    },
    {
      ...
      items: [
        ...
        { prompt: "Kolik dní má rok, který není přestupný?", options: ["365", "366", "360", "364"], answer: "365", explanation: "Běžný rok má 365 dní, přestupný 366 – únor má 29 dní." },
    ...
    },
    {
      ...
      items: [
        ...
        { prompt: "Kolik vody se vejde do vany?", options: ["asi 150 l", "asi 15 l", "asi 1500 l", "asi 5 l"], answer: "asi 150 l", explanation: "Do vany se vejde přes sto litrů." },
        ...
        { prompt: "Jak dlouho trvá dospělému ujít 1 km?", options: ["asi 12 minut", "asi 2 minuty", "asi 1 hodinu", "asi 2 hodiny"], answer: "asi 12 minut", explanation: "Chůzí ujdeme přibližně 5 km za hodinu, tedy 1 km asi za 12 minut." },
    ...
    },
    {
      ...
      icon: "🧮",
      type: "write",
      instructions: "Napiš jen číslo bez jednotky. U času napiš čas ve tvaru 14:05.",
      pick: "auto",
      items: [
        { prompt: "Kolik metrů je 4 km 60 m? Napiš počet metrů.", answer: "4060", accept: ["4 060"], explanation: "4 km = 4000 m, plus 60 m = 4060 m." },
        { prompt: "Kolik gramů je 2 kg 300 g?", answer: "2300", accept: ["2 300"], explanation: "2 kg = 2000 g, plus 300 g = 2300 g." },
        ...
        { prompt: "Film začal v 18:30 a trval 105 minut. V kolik hodin skončil? Napiš ve tvaru 14:05.", answer: "20:15", explanation: "105 min = 1 h 45 min. 18:30 + 1 h 45 min = 20:15." }
      ]
    }
  ]
});
